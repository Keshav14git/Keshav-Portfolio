...
const ImageModal = ({ isOpen, onClose, images, projectTitle }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-md">
      ...
      <button
        onClick={onClose}
        className="absolute top-6 right-6 z-60 text-white hover:text-red-400 transition-colors duration-300"
      >
      ...
      <div className="relative w-full h-full flex items-center justify-center p-8">
        ...
        <button
          onClick={prevImage}
          className="absolute left-8 z-60 text-white/70 hover:text-white hover:scale-110 transition-all duration-300"
        >
        ...
        <button
          onClick={nextImage}
          className="absolute right-8 z-60 text-white/70 hover:text-white hover:scale-110 transition-all duration-300"
        >
          <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative max-w-5xl max-h-full">
          ...
          <img
            ...
            className="max-w-full max-h-full object-contain rounded-lg shadow-2xl opacity-0 animate-[fadeIn_0.5s_ease-in-out_forwards]"
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:gap-4">
                  {project.link ? (
                    ...
                    <span className="text-white/40 text-xs sm:text-sm font-light tracking-[0.15em] uppercase mb-2 sm:mb-0">
                      {project.status}
                    </span>
                  )}
